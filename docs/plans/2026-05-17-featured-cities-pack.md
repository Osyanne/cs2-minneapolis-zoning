  ...
  document.body.innerHTML = `
    <div style="padding: 2rem; font-family: sans-serif; color: #c9d1d9; background: #0d1117; min-height: 100vh;">
      ...
      <p><a href="index.html" style="color: #58a6ff;">← Volver a landing</a> · 
         <a href="https://github.com/Osyanne/CitiesSkylines2-osm-toolkit/issues/new" 
...
Vial + services for the 4 newer cities are **on-demand**: open a [City Request issue](https://github.com/Osyanne/CitiesSkylines2-osm-toolkit/issues/new?template=city-request.yml) requesting them, and we'll generate.
...
Open `https://github.com/Osyanne/CitiesSkylines2-osm-toolkit/settings/pages` in browser.
...
GitHub will show a "Your site is live at https://osyanne.github.io/CitiesSkylines2-osm-toolkit/" después de ~1-2 min.

- [ ] **Step 3: Verify deployment**

Open `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/` (puede tardar 1-5 min en propagar).
...
Open browser DevTools → Network tab → load `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/map.html?city=minneapolis`.

Verify:
- Request a `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/cities.json` → status **200** (no 404)
- Request a `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/cities/minneapolis/manifest.json` → **200**
- 3 requests a `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/cities/minneapolis/datos_*.js?v=<hash>` → todos **200**
...
For each slug:
- `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/map.html?city=minneapolis`
- `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/map.html?city=manhattan`
- `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/map.html?city=tokyo`
- `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/map.html?city=amsterdam`
- `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/map.html?city=madison`

Verify cada uno carga, console limpia, mapa renderea.

- [ ] **Step 6: Verify slug-inválido redirect**

`https://osyanne.github.io/CitiesSkylines2-osm-toolkit/map.html?city=atlantis`
...
- GH Pages activo en `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/`
...
Una vez el PR sea reviewed/merged a main, volver a `https://github.com/Osyanne/CitiesSkylines2-osm-toolkit/settings/pages`:
...
Recargar `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/`. Esperar 1-5 min.
