...
git branch -M main
git remote add origin https://github.com/Osyanne/CitiesSkylines2-osm-toolkit.git
...
The live map will be at: `https://osyanne.github.io/CitiesSkylines2-osm-toolkit/`
